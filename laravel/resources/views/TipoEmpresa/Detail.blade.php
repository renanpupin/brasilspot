...
@section('content')
    ...
    <div class="content-title grid-m-12 grid-s-12 grid-xs-12">
        <h2>Tipo Empresa #{{ $tipoEmpresa->id }}</h2>
    </div>
    ...
    <div id="detalhar" class="grid-m-12 grid-s-12">
        ...
        <div class="row">
            ...
            <div class="form-group grid-m-12 grid-s-12 grid-xs-12">
                ...
                <p class="field-disabled">{{ $tipoEmpresa->tipo }}</p>
            </div>
            ...
            <div class="form-group grid-m-3 grid-s-3 button-field">
                <a href="{{ route('TipoEmpresa.edit', $tipoEmpresa->id) }}" id="btnEditar" title="Editar" class="btn btn-primary ripple">
