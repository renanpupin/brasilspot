    ...
    <div class="content-title grid-m-12 grid-s-12 grid-xs-12">
        ...
        <div class="breadcrumbs-content container">
            <div class="row">
                ...
                Você está em:
                <ul>
                    <li><a href="{{ url('Comerciante/Reclamacoes') }}">Comerciantes</a></li>
                    <li>Reclamações</li>
                </ul>
            </div>
        </div>
                ...
                @foreach($reclamacoes as $reclamacao)
                    <tr>
                        ...
                        <td class="col-actions">
                            <a href="{{ url('Comerciante/Reclamacoes',[$reclamacao->id]) }}" title="Detalhar"><i class="material-icons">description</i></a>
                        </td>
                        <td class="col-actions">
