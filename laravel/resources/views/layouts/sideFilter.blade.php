            ...
            <div class="filter-list">
                <ul>
                    <li>
                        ...
                        <a href="{{url((Request::segment(1) ? "/".Request::segment(1) : null).(sizeof(Request::input()) > 0 ? "?" : null).(sizeof(Request::input("tipo")) > 0 ? "tipo=".(Request::input("tipo")) : null).(sizeof(Request::input("local")) > 0 ? (sizeof(Request::input("tipo")) > 0 ? "&" : null)."local=".(Request::input("local")) : null).(sizeof(Request::input("com")) > 0 ? (sizeof(Request::input("local")) > 0 ? "&" : null).("com=".Request::input("com")) : null)).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null)}}">- Todas</a>
                    </li>
                    @foreach ($categorias as $id => $nome)
                        <li>
                            {{--{{dd(Request::segment(2))}}--}}
                            <a href="{{url((Request::segment(1) ? "/".Request::segment(1) : null).(Request::segment(2) == null ? "/".str_slug($nome) : null).(sizeof(Request::input()) > 0 ? "?" : null).(sizeof(Request::input("tipo")) > 0 ? "tipo=".(Request::input("tipo")) : null).(sizeof(Request::input("local")) > 0 ? (sizeof(Request::input("tipo")) > 0 ? "&" : null)."local=".(Request::input("local")) : null).(sizeof(Request::input("com")) > 0 ? (sizeof(Request::input("local")) > 0 ? "&" : null).("com=".Request::input("com")) : null)).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null)}}">- {{$nome}}</a>
                        </li>
                    @endforeach
                </ul>
            </div>
    ...
    <div class="grid-m-12 grid-s-12 grid-xs-12">
        <div class="side-filter">
            ...
            <div class="filter-list">
                ...
                <ul id="listaEstados">
                    <li>
                        <a href="{{url(Request::path().(sizeof(Request::input()) > 0 ? "?" : null).(sizeof(Request::input("tipo")) > 0 ? ("tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Todos</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=ac".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Acre</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=al".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Alagoas</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=ap".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Amapá</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=am".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Amazonas</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=ba".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Bahia</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=ce".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Ceará</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=df".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Distrito Federal</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=es".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Espírito Santo</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=go".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Goiás</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=ma".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Maranhão</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=mt".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Mato Grosso</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=ms".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Mato Grosso do Sul</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=mg".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Minas Gerais</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=pa".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Pará</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=pb".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Paraíba</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=pr".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Paraná</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=pe".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Pernambuco</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=pi".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Piauí</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=rj".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Rio de Janeiro</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=rn".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Rio Grande do Sul</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=rs".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Rio Grande do Norte</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=ro".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Rondônia</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=rr".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Roraima</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=sc".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Santa Catarina</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=sp".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- São Paulo</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=se".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Sergipe</a>
                    </li>
                    <li>
                        <a href="{{url(Request::path()."?local=to".(sizeof(Request::input("tipo")) > 0 ? ("&tipo=".Request::input("tipo")) : null).(sizeof(Request::input("com")) > 0 ? ("&com=".Request::input("com")) : null).(sizeof(Request::input("pesquisaEmpresa")) > 0 ? ("&pesquisaEmpresa=".Request::input("pesquisaEmpresa")) : null).(sizeof(Request::input("pesquisaEndereco")) > 0 ? ("&pesquisaEndereco=".Request::input("pesquisaEndereco")) : null))}}">- Tocantins</a>
                    </li>
                </ul>
            </div>
        </div>
